...
#function Action : return the vector after normalization action
...
def feats_to_vec(features):
    ...
    for two_letter_combination in features:
        if two_letter_combination in utils.F2I:
            m_id = utils.F2I[two_letter_combination]
            # update count
            vec[m_id] = 1 + vec[m_id]
...
if __name__ == '__main__':
    ...
    optimal_params = train_classifier(train_data, dev_data, num_iterations, learning_rate, params)
    CreatePredictionsFile(test_data, optimal_params)
